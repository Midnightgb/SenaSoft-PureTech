...
from crud.recycling_point import get_recycling_point_by_id, register_recycling_point, get_recycling_point_list
...
def get_recycling_point_list_db(skip: int = 0, limit: int = 10, db: Session = Depends(get_db)):
